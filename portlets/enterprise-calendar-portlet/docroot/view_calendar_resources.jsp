...
<c:choose>
	<c:when test="<%= displayTerms.getScope() == themeDisplay.getCompanyGroupId() %>">
		...
		long[] classNameIds = new long[] {PortalUtil.getClassNameId(User.class.getName())};
		...
		calendarResourceSearch = new CalendarResourceSearch(renderRequest, iteratorURL, CalendarResourceSearch.DEFAULT_CUR_PARAM + "_sites");
