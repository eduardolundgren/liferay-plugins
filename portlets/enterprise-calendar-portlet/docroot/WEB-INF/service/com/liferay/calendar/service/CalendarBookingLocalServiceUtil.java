	...
	*/
	...
	public static com.liferay.calendar.model.CalendarBooking addCalendarBooking(
		...
		return getService()
			...
			startDateMinute, startDateTimeZone, endDateMonth, endDateDay,
			endDateYear, endDateHour, endDateMinute, endDateTimeZone, allDay,
			recurrence, priority, outOfOffice, remindBy, firstReminder,
			secondReminder, required, requestMessage, responseMessage,
			serviceContext);
	}

	public static void addCalendarBookingResources(
		com.liferay.calendar.model.CalendarBooking calendarBooking,
		boolean addGroupPermissions, boolean addGuestPermissions)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		getService()
			.addCalendarBookingResources(calendarBooking, addGroupPermissions,
			addGuestPermissions);
	}
	...
	public static void addCalendarBookingResources(
		...
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		getService()
			.addCalendarBookingResources(calendarBooking, groupPermissions,
			guestPermissions);
	}

	public static void addCalendarBookingResources(long calendarBookingId,
		boolean addGroupPermissions, boolean addGuestPermissions)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		getService()
			.addCalendarBookingResources(calendarBookingId,
	...
	public static void addCalendarBookingResources(long calendarBookingId,
		...
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		getService()
			.addCalendarBookingResources(calendarBookingId, groupPermissions,
			guestPermissions);
	}
	...
	public static void updateCalendarBookingResources(
		com.liferay.calendar.model.CalendarBooking calendarBooking,
		java.lang.String[] groupPermissions, java.lang.String[] guestPermissions)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		getService()
			.updateCalendarBookingResources(calendarBooking, groupPermissions,
			guestPermissions);
	}
