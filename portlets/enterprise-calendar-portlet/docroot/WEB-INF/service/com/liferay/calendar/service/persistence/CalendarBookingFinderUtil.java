...
public class CalendarBookingFinderUtil {
	...
	public static int countByC_G_C_C_P_T_D_L_T_S_E_S(long companyId,
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return getFinder()
				   .countByC_G_C_C_P_T_D_L_T_S_E_S(companyId, groupIds,
	...
	public static int countByC_G_C_C_P_T_D_L_T_S_E_S(long companyId,
		...
		java.lang.String[] types, java.util.Date startDate,
		java.util.Date endDate, int status, boolean andOperator)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getFinder()
				   .countByC_G_C_C_P_T_D_L_T_S_E_S(companyId, groupIds,
			calendarIds, calendarResourceIds, parentCalendarBookingId, titles,
			descriptions, locations, types, startDate, endDate, status,
			andOperator);
	}
	...
	public static int filterCountByC_G_C_C_P_T_D_L_T_S_E_S(long companyId,
		long[] groupIds, long[] calendarIds, long[] calendarResourceIds,
		long parentCalendarBookingId, java.lang.String title,
		java.lang.String description, java.lang.String location,
		java.lang.String type, java.util.Date startDate,
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return getFinder()
				   .filterCountByC_G_C_C_P_T_D_L_T_S_E_S(companyId, groupIds,
			calendarIds, calendarResourceIds, parentCalendarBookingId, title,
			description, location, type, startDate, endDate, status, andOperator);
	}
	...
	public static java.util.List<com.liferay.calendar.model.CalendarBooking> filterFindByC_G_C_C_P_T_D_L_T_S_E_S(
		long companyId, long[] groupIds, long[] calendarIds,
		long[] calendarResourceIds, long parentCalendarBookingId,
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return getFinder()
				   .filterFindByC_G_C_C_P_T_D_L_T_S_E_S(companyId, groupIds,
			calendarIds, calendarResourceIds, parentCalendarBookingId, title,
	...
	public static java.util.List<com.liferay.calendar.model.CalendarBooking> filterFindByC_G_C_C_P_T_D_L_T_S_E_S(
		...
		java.lang.String[] locations, java.lang.String[] types,
		java.util.Date startDate, java.util.Date endDate, int status,
		boolean andOperator, int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	public static java.util.List<com.liferay.calendar.model.CalendarBooking> findByC_G_C_C_P_T_D_L_T_S_E_S(
		long companyId, long[] groupIds, long[] calendarIds,
		long[] calendarResourceIds, long parentCalendarBookingId,
		java.lang.String title, java.lang.String description,
		java.lang.String location, java.lang.String type,
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return getFinder()
				   .findByC_G_C_C_P_T_D_L_T_S_E_S(companyId, groupIds,
			calendarIds, calendarResourceIds, parentCalendarBookingId, title,
			description, location, type, startDate, endDate, status,
			andOperator, start, end, orderByComparator);
	}
