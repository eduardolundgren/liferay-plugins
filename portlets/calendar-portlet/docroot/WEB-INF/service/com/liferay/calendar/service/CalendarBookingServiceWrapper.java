...
public class CalendarBookingServiceWrapper implements CalendarBookingService,
	...
	*/
	...
	public com.liferay.calendar.model.CalendarBooking addCalendarBooking(
		...
		java.lang.String location, int startYear, int startMonth, int startDay,
		int startHour, int startMinute, int endYear, int endMonth, int endDay,
		int endHour, int endMinute, java.lang.String timeZoneId,
		...
		return _calendarBookingService.addCalendarBooking(calendarId,
			...
			descriptionMap, location, startYear, startMonth, startDay,
			startHour, startMinute, endYear, endMonth, endDay, endHour,
			endMinute, timeZoneId, allDay, recurrence, firstReminder,
	...
	public com.liferay.calendar.model.CalendarBooking updateCalendarBookingInstance(
		...
		return _calendarBookingService.updateCalendarBookingInstance(calendarBookingId,
			...
			endMonth, endDay, endHour, endMinute, timeZoneId, allDay,
