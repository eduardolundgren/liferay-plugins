...
public class CalendarBookingServiceImpl extends CalendarBookingServiceBaseImpl {
	...
	public void deleteCalendarBookingInstance(
		...
		calendarBookingLocalService.deleteCalendarBookingInstance(
			calendarBookingId, startTime, allFollowing, updateChildCalendars);
	}
	...
	@Override
	public CalendarBooking getCalendarBookings(
	...
	public int getChildCalendarBookingsCount(long parentCalendarBookingId)
		...
		return calendarBookingLocalService.getChildCalendarBookingsCount(
				parentCalendarBookingId);
	}
